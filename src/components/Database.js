const kerelabg = "https://i.ibb.co/b3mJVsH/Keralabg.jpg";
const tamilbg = "https://i.ibb.co/7KyJg3L/Tamil-Nadubg.jpg";
const karnatakabg = "https://i.ibb.co/z81XtRJ/Karnatakabg.jpg";
const kashmirbg = "https://i.ibb.co/MMqfD7t/Kashmirbg.jpg";
const agrabg = "https://i.ibb.co/qBCq11d/agrabg.jpg";
const shimlabg = "https://i.ibb.co/2vMNtVK/Shimlabg.jpg";

const assambgi = "https://i.ibb.co/rs6Qjtd/assambg.jpg";
const meghalayabg = "https://i.ibb.co/s973Gmf/meghalayabg.png";
const sikkimbg = "https://i.ibb.co/9VVFdzJ/sikkimbg.png";
const rajasthanbg = "https://i.ibb.co/NyTwVsY/rajasthanbg.jpg";
const gujratbg = "https://i.ibb.co/jv0Y6xh/gujratbg.jpg";
const maharashtrabg = "https://i.ibb.co/nP2XGf2/mahabg.jpg";
...
const north = [
	{
		...
		attractions: [
			{
				attraction: "Srinagar",
				dp: "https://i.ibb.co/v3MnKbq/Shrinagar.jpg",
				desc:
		...
		attractions: [
			{
				...
				dp: "https://i.ibb.co/kQ9dZcF/Taj-mahal.jpg",
				desc:
			...
			{
				attraction: "Fatehpur Sikri",
				dp: "https://i.ibb.co/XyTZcpD/Fatahpur.jpg",
				desc:
			...
			{
				attraction: "Agra",
				dp: "https://i.ibb.co/tp4Cv2Z/Agra-fort.jpg",
				desc:
					"One of the seven wonders of the world, Taj Mahal is located on the banks of River Yamuna in Agra. It was built by the Mughal Emperor Shah Jahan as a memorial for his third wife, Mumtaz Mahal. It also houses the tomb of Shah Jahan himself. Constructed entirely out of white marble in the 17th century, Taj Mahal is one of the most beautiful monuments in the world. Every year visitors numbering more than the entire population of Agra pass through the magnificent gates to catch a glimpse of this breathtaking monument!",
			},
		],
...
const south = [
	{
		...
		dp: karnatakabg,
		desc:
			"The geography and landscape of Karnataka is such that it serves as an ideal destination for diverse and enthralling tourist locations and landmarks. Located in the midst of Western Ghats, Deccan Plateau and Kannad Coast, Karnataka is home to various forests, beaches, waterfalls, coffee plantations, lakes and all the bounties of nature.The state also boasts of historically significant monuments and structures that attract visitors from far and beyond.  Also culturally diverse and ancient, Karnataka has a historic past and rich heritage for the travelers to explore.",
		attractions: [
			{
				attraction: "Mysore",
				dp: "https://i.ibb.co/X2ncZNR/Mysore.jpg",
				desc:
			...
			{
				attraction: "Chikmangalur",
				dp: "https://i.ibb.co/LYd9hwm/Chikmagalur.jpg",
				desc:
			...
			{
				attraction: "Bangalore",
				dp: "https://i.ibb.co/gRq3kCg/Bangalore.jpg",
				desc:
	...
	},
	{
		place: "Kerala",
		dp: kerelabg,
		desc: "Kerala is a state on the Malabar Coast of India.",
		attractions: [
			{
				attraction: "Wayanad",
				dp: "https://i.ibb.co/9HwNQ9X/Wayanad.jpg",
				desc:
					"Wayanad, one of the most visited hill stations in Kerala, beckons trekking enthusiasts and nature lovers. Its rolling hills and lush green forests are home to a number of animals and birds.",
			},
			{
				attraction: "Varkala",
				dp: "https://i.ibb.co/vP50Rgs/Varkala.jpg",
				desc:
					"Varkala, a small town in Kerala, also boasts of one of the top beaches in South India. The pristine white sandy Varkala beach is offset by majestic cliffs that make it a popular site with photographers. The town caters to backpackers as well as families. ",
			},
			{
				attraction: "Munnar",
				dp: "https://i.ibb.co/k46ts12/Munnar.jpg",
				desc:
					"With misty clouds and rolling green hills, Munnar has often been named one of the most picturesque hill stations of South India. It almost seems as though the place is carpeted with tea plantations. A visit here is all the encouragement one needs to sample the different aromas and flavors of tea.",
			},
		],
	},
	{
		...
		dp: tamilbg,
		desc:
			"Boasting cultural opulence; gorgeous coastline; wildlife richness; hill stations to be enamoured of; and temples with intricate carvings to imbibe spirituality, Tamil Nadu is a destination in India that cannot be ignored.",
		attractions: [
			{
				attraction: "OOTY",
				dp: "https://i.ibb.co/Ct16jf3/OOTY.jpg",
				desc:
					"Ooty, the Queen of Hill Stations, balances the hustle and bustle of city life with expansive tea gardens. The charming bungalows from the British-Raj era add a romantic flavor to Ooty, making it one of the most popular honeymoon destinations in South India. Its famous miniature toy train is listed as a UNESCO World Heritage Site and is a delight for people of all ages.",
			},
			{
				attraction: "Chennai",
				dp: "https://i.ibb.co/Lnz5Fx4/Chennai.jpg",
				desc:
					"Chennai, the capital of Tamil Nadu, is a blend of the old and the new. It is often described as the keeper of South Indian traditions. While on one hand, it flaunts spectacular architecture from the city’s past, on the other, it is known for its cosmopolitan lifestyle, quirky cafes and boutique stores. The city also boasts of the second-longest urban beach in the world.",
			},
			{
				attraction: "Mahabalipuram",
				dp: "https://i.ibb.co/1f5HRcq/Mahabalipuram.jpg",
				desc:
...
const east = [
		...
		attractions: [
			{
				...
				dp: "https://i.ibb.co/48kswVL/Kamakhyatemple.jpg",
				desc:
					"One of the seven wonders of the world, Taj Mahal is located on the banks of River Yamuna in Agra. It was built by the Mughal Emperor Shah Jahan as a memorial for his third wife, Mumtaz Mahal. It also houses the tomb of Shah Jahan himself. Constructed entirely out of white marble in the 17th century, Taj Mahal is one of the most beautiful monuments in the world. Every year visitors numbering more than the entire population of Agra pass through the magnificent gates to catch a glimpse of this breathtaking monument!",
			},
			{
				attraction: "Kamakhya Temple",
				dp:
					"https://i.ibb.co/TYYbGtb/Nagaon-July-07-2017-Wro-adult-rhibos-with-a-calf-at-a-highland-during-flood-at-Kaziranga-National-Pa.jpg",
				desc:
					"Located at a distance of 40km from Agra, Fatehpur Sikri is a town in the Agra district and a famous tourist attraction. A city predominantly made of red sandstone, Fatehpur Sikri was founded in 1571 century by Mughal Emperor Akbar. It is essentially a fortified city built by the king and had been the capital of his Empire for fifteen years. Now a UNESCO world heritage site, it is home to Jodha Bai's Palace, Jama Mosque, Buland Darwaza, and Tomb of Salim Chisti among many other famous monuments. Derived from Arab and central Asian tent encampments, the Imperial Complex is a work of pavilions arranged in formal geometry on a piece of land. ",
			},
			{
				attraction: "Umananda Island",
				dp: "https://i.ibb.co/tbtjWdL/Umananda.jpg",
				desc:
					"One of the seven wonders of the world, Taj Mahal is located on the banks of River Yamuna in Agra. It was built by the Mughal Emperor Shah Jahan as a memorial for his third wife, Mumtaz Mahal. It also houses the tomb of Shah Jahan himself. Constructed entirely out of white marble in the 17th century, Taj Mahal is one of the most beautiful monuments in the world. Every year visitors numbering more than the entire population of Agra pass through the magnificent gates to catch a glimpse of this breathtaking monument!",
			},
		],
	},
	{
		...
		attractions: [
			{
				attraction: "Elephant Fall",
				dp: "https://i.ibb.co/fSRdQ20/elephantfall.png",
				desc:
					"One of the seven wonders of the world, Taj Mahal is located on the banks of River Yamuna in Agra. It was built by the Mughal Emperor Shah Jahan as a memorial for his third wife, Mumtaz Mahal. It also houses the tomb of Shah Jahan himself. Constructed entirely out of white marble in the 17th century, Taj Mahal is one of the most beautiful monuments in the world. Every year visitors numbering more than the entire population of Agra pass through the magnificent gates to catch a glimpse of this breathtaking monument!",
			},
			{
				attraction: "Masmai Cave",
				dp: "https://i.ibb.co/Mg500NH/masmaicave.png",
				desc:
					"Located at a distance of 40km from Agra, Fatehpur Sikri is a town in the Agra district and a famous tourist attraction. A city predominantly made of red sandstone, Fatehpur Sikri was founded in 1571 century by Mughal Emperor Akbar. It is essentially a fortified city built by the king and had been the capital of his Empire for fifteen years. Now a UNESCO world heritage site, it is home to Jodha Bai's Palace, Jama Mosque, Buland Darwaza, and Tomb of Salim Chisti among many other famous monuments. Derived from Arab and central Asian tent encampments, the Imperial Complex is a work of pavilions arranged in formal geometry on a piece of land. ",
			},
			{
				attraction: "Shilong",
				dp: "https://i.ibb.co/LYk6ZYK/shillong.jpg",
				desc:
					"One of the seven wonders of the world, Taj Mahal is located on the banks of River Yamuna in Agra. It was built by the Mughal Emperor Shah Jahan as a memorial for his third wife, Mumtaz Mahal. It also houses the tomb of Shah Jahan himself. Constructed entirely out of white marble in the 17th century, Taj Mahal is one of the most beautiful monuments in the world. Every year visitors numbering more than the entire population of Agra pass through the magnificent gates to catch a glimpse of this breathtaking monument!",
			},
		],
	},
	{
		...
		attractions: [
			{
				attraction: "Gangtok",
				dp: "https://i.ibb.co/kx9jfNG/gangtok.jpg",
				desc:
					"One of the seven wonders of the world, Taj Mahal is located on the banks of River Yamuna in Agra. It was built by the Mughal Emperor Shah Jahan as a memorial for his third wife, Mumtaz Mahal. It also houses the tomb of Shah Jahan himself. Constructed entirely out of white marble in the 17th century, Taj Mahal is one of the most beautiful monuments in the world. Every year visitors numbering more than the entire population of Agra pass through the magnificent gates to catch a glimpse of this breathtaking monument!",
			},
			{
				attraction: "Zuluk",
				dp: "https://i.ibb.co/pjLkBdQ/zuluk.jpg",
				desc:
					"Located at a distance of 40km from Agra, Fatehpur Sikri is a town in the Agra district and a famous tourist attraction. A city predominantly made of red sandstone, Fatehpur Sikri was founded in 1571 century by Mughal Emperor Akbar. It is essentially a fortified city built by the king and had been the capital of his Empire for fifteen years. Now a UNESCO world heritage site, it is home to Jodha Bai's Palace, Jama Mosque, Buland Darwaza, and Tomb of Salim Chisti among many other famous monuments. Derived from Arab and central Asian tent encampments, the Imperial Complex is a work of pavilions arranged in formal geometry on a piece of land. ",
			},
			{
				attraction: "Tsomgo Lake",
				dp: "https://i.ibb.co/NtSsQ04/tsomgolake.jpg",
				desc:
					"One of the seven wonders of the world, Taj Mahal is located on the banks of River Yamuna in Agra. It was built by the Mughal Emperor Shah Jahan as a memorial for his third wife, Mumtaz Mahal. It also houses the tomb of Shah Jahan himself. Constructed entirely out of white marble in the 17th century, Taj Mahal is one of the most beautiful monuments in the world. Every year visitors numbering more than the entire population of Agra pass through the magnificent gates to catch a glimpse of this breathtaking monument!",
			},
		],
...
const west = [
	...
	},
	{
		...
		attractions: [
			{
				attraction: "Dwarka",
				dp: "https://i.ibb.co/F6TKcMC/dwarka.jpg",
				desc:
			...
			},
			{
				...
				dp: "https://i.ibb.co/42B22Lg/kutch.jpg",
				desc:
			...
			},
			{
				...
				dp: "https://i.ibb.co/7GvQP32/suntemple.jpg",
				desc:
	...
	},
	{
		...
		attractions: [
			{
				attraction: "Lonavla",
				dp: "https://i.ibb.co/8Byq6zN/lonavla.jpg",
				desc: "",
			},
			{
				attraction: "Mahabaleshwar",
				dp: "https://i.ibb.co/5KxTZJz/mahabaleshwar.jpg",
				desc: " ",
			},
			{
				attraction: "Shirdi",
				dp: "https://i.ibb.co/PrYrKkk/shirdi.jpg",
				desc: "",
			},
		],
	},
